...
def run_collect_results(save_dir, one_line, metric='onlymeans',model='cvae'):
    records = []
    ...
    os.system('cp {}/model_seed={}_epoch={}.pt {}/best_model.pt'.format(
            best_stats["training_args"]["save_dir"],
            best_stats["training_args"]["seed"],
            best_stats["best_epoch"],
            best_stats["training_args"]["save_dir"]))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--metric', type=str, default='onlymeans')
    parser.add_argument('--model', type=str, default='cpa')

    args = parser.parse_args()
    run_collect_results(args.save_dir, args.one_line, args.metric, args.model)
